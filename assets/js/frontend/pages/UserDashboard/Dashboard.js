...
export default function Dashboard() {
	...
	return (
		<DashboardWrapper>
			<div
				className={ `helpgent-user-dashboard__contents ${
					userData.length === 0 || showLogin
						? 'helpgent-user-dashboard__contents--login'
						: ''
				}` }
			>
				{ userData.is_guest === '1' && ! showLogin && (
					<div className="helpgent-user-dashboard__actions">
						<span className="helpgent-user-status">
