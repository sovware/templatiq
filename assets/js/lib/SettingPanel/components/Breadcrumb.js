export default function Breadcrumb( {
	...
	return (
		<div className="helpgent-settings-panel-breadcrumb">
			{ routes.map( ( routeLabel, index, items ) => {
				...
				return (
					<div key={ index }>
						<span
							className={ `helpgent-breadcrumb-label${
						...
						{ ! isLastItem && (
							<span className="helpgent-breadcrumb-label helpgent-breadcrumb-separator">
								&#x3E;
							</span>
						) }
					</div>
