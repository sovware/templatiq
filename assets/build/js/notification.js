...
const Notification = () => {
  ...
  const pushNotification = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(data => {
    const config = Object.assign({
      ...
      transition: react_toastify__WEBPACK_IMPORTED_MODULE_4__.Bounce
    }, data || {});
    setToastConfig(config);
    react_toastify__WEBPACK_IMPORTED_MODULE_4__.toast[config.type]((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      dangerouslySetInnerHTML: {
        __html: config.message
      }
    }));
  }, []);
