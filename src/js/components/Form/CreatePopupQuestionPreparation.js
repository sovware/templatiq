...
import handleCreateForm from '@helper/handleCreateForm';
...
export default function CreatePopupQuestionPreparation( props ) {
	...
	} = usePostMutation( `/template-market/admin/form/media` );
	...
	return (
		<QuestionPreparationStyle>
			<h4 className="template-market-import-attachment__title">
				Import attachment progress
			</h4>
			<div className="template-market-import-attachment__progress">
				<ProgressBar
					type="success"
					currentValue={ importPercentage }
					contentFlow="horizontal"
				/>
				<span className="template-market-import-attachment__percentage">
