			...
			>	
				<div className="templatiq__modal__content">
					<h2 className="templatiq__modal__title">
						{ __( 'Liked This Template?' , 'helpgent' ) }
					</h2>
					<p className="templatiq__modal__desc">
						{ __( 'This is a premium template. Get access to this premium template.' , 'helpgent' ) }
					</p>
					<a 
...

					{
						!isLoggedIn && (
							<div className="templatiq__modal__pro-auth">
								<p className="templatiq__modal__desc">
									{ __( 'Already a Premium Member?' , 'helpgent' ) }
								</p>
								<button
