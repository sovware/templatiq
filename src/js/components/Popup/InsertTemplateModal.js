...
const InsertTemplateModal = (props) => {
    const { template_id, builder, slug } = props.item;
    ...
    let closeModal = (e) => {
        ...
        let templatiqModalOpen = document.querySelector(".insert-modal-open");

        templatiqRoot && templatiqRoot.classList.remove("templatiq-overlay-enable");
        templatiqModalOpen && templatiqModalOpen.classList.remove("insert-modal-open");
    }
