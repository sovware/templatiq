...
export default function App( props ) {
	...
	return (
		<SettingPanelStyle className="helpgent-settings-panel">
			{ isLoading ? (
				<LoaderContent />
			) : (
				<Suspense fallback={ <ContentLoading /> }>
					<form onSubmit={ form.handleSubmit( onSubmit ) }>
						<div className="helpgent-settings-panel-header">
							<Breadcrumb
							...
							<div className="helpgent-settings-panel-action">
								<SaveButton
									buttonRef={ buttonRef }
									isSaving={ isSaving }
									message={ message }
						...
						<div className="helpgent-settings-panel-body">
							<Navigation />

							<div className="helpgent-settings-panel-contents">
								<Routes>
						...
						<div className="helpgent-settings-panel-footer">
							<div className="helpgent-settings-panel-action">
								<SaveButton
									buttonRef={ buttonRef }
									isSaving={ isSaving }
