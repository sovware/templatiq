...
export default function DropDownMenuItem( { menu } ) {
	...
	return (
		<div className="helpgent-settings-panel-nav-menu-item --has-dropdown">
			<NavLink
				to={ `${
			...
			>
				...
				<span className="helpgent-settings-panel-nav-menu-action">
					<ReactSVG src={ caretDown } />
				</span>
			</NavLink>

			<div className="helpgent-settings-panel-nav-menu-dropdown">
