...
class Http {
	...
	public function __construct() {
		$this->dev_mode = defined( 'TEMPLATE_MARKET_DEV' ) && TEMPLATE_MARKET_DEV;
	}
	...
	protected function prepareArgs( $args ) {
		...
		foreach ( $args as $key => $value ) {
			switch ( true ) {
				case is_int( $value ):
				case is_bool( $value ):
				case is_string( $value ) && ( 'true' === $value || 'false' === $value ):
	...
	public function post( $args = [] ) {
		...
		if ( defined( 'TEMPLATELY_DEBUG_LOG' ) && TEMPLATE_MARKET_DEBUG_LOG ) {
