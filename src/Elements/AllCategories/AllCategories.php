...
class AllCategories extends Widget_Base {
	...
	public function get_title() {
		return __( 'All Categories', 'template-market' );
	}
	...
	protected function register_contents(): void{
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} #directorist.atbd_wrapper .atbd_all_categories .atbd_category_single .cat-box' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'grid' => __( 'Grid View', 'template-market' ),
					'list' => __( 'List View', 'template-market' ),
				],
				'default'   => 'grid',
				'separator' => 'before',
			]
		...
		$this->add_control(
			'columns',
			[
				'label'     => __( 'Categories Per Row', 'template-market' ),
				'type'      => Controls_Manager::SELECT,
		...
		$this->add_control(
			'order_list',
			[
				'label'     => __( 'Categories Order', 'template-market' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
		...
		$this->add_control(
			'number_cat',
			[
				'label'     => __( 'Number of Categories to Show', 'template-market' ),
	...
	protected function register_styles(): void {
		...
		$this->register_text_controls(
			__( 'Listing Count', 'template-market' ),
