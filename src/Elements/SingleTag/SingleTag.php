...
namespace TemplateMarket\Elements\SingleTag;
...
class SingleTag extends Widget_Base {
	...
	public function get_title() {
		return __( 'Single Tag', 'template-market' );
	}
	...
	protected function register_styles(): void {
		...
		$this->register_container_style_controls( __( 'Directory Type: Container', 'template-market' ), 'single_tag_directory_type_container', '.directorist-type-nav__list' );
		...
		$this->register_container_style_controls( __( 'Listing Header: Container', 'template-market' ), 'single_tag_header_container', '.directorist-listings-header' );

		$this->register_filters_button( ['header' => 'yes', 'advanced_filter' => 'yes'] );

		$this->register_text_controls( __( 'Listing Header: Listings Found', 'template-market' ), 'single_tag_listings_found', '.directorist-listings-header__left .directorist-header-found-title' );

		$this->register_view_as_sort_by();

		$this->register_container_style_controls( __( 'Listing: Card Container', 'template-market' ), 'single_tag_listing_card_container', '.directorist-listing-card' );

		$this->register_listing_card_info();
		$this->register_listing_footer();

		$this->register_container_style_controls( __( 'Pagination Container', 'template-market' ), 'single_tag_pagination_container', '.directorist-pagination', ['show_pagination' => 'yes'] );
	...
	protected function render(): void {
		 ...
		 */
		$atts = apply_filters( 'directorist_single_tag_elementor_widget_atts', $atts, $settings );

		Helper::run_shortcode( 'directorist_tag', $atts );
	}
}
