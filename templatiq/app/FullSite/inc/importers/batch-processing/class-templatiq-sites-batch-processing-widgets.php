...
if ( ! class_exists( 'Templatiq_Sites_Batch_Processing_Widgets' ) ) :

	/**
	 * Templatiq_Sites_Batch_Processing_Widgets
	 *
	 * @since 1.0.14
	 */
	class Templatiq_Sites_Batch_Processing_Widgets {
		...
		public function import() {
			...
			// Catch mapping data.
			$this->wpforms_ids_mapping = get_option( 'templatiq_sites_wpforms_ids_mapping', array() );
		...
		public function widget_wpform() {
			...
			Templatiq_Sites_Importer_Log::add( '---- Processing Contact Form Mapping from WP Forms Widgets -----' );
		...
		public function widget_text() {
			...
			Templatiq_Sites_Importer_Log::add( '---- Processing Contact Form Mapping from Text Widgets -----' );
		...
		public function widget_media_image() {
			...
			Templatiq_Sites_Importer_Log::add( '---- Processing Images from Widgets -----' );
	 ...
	 */
	Templatiq_Sites_Batch_Processing_Widgets::get_instance();
