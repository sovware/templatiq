...
if ( ! class_exists( 'Templatiq_Sites_Batch_Site_Import_Batch' ) && class_exists( 'WP_Background_Process' ) ) :
	 ...
	 * @since 2.5.0
	 */
	class Templatiq_Sites_Batch_Site_Import_Batch extends WP_Background_Process {
		 ...
		 * @var string
		 */
		protected $action = 'templatiq_sites_site_import_batch';
