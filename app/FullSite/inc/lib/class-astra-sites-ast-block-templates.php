...
if ( ! class_exists( 'Templatiq_Sites_Ast_Block_Templates' ) ) :

	/**
	 * Admin
	 */
	class Templatiq_Sites_Ast_Block_Templates {

		/**
		 * Instance
		 *
		 * @since 1.0.0
		 * @var (Object) Templatiq_Sites_Ast_Block_Templates
		 */
	 ...
	 */
	Templatiq_Sites_Ast_Block_Templates::get_instance();
