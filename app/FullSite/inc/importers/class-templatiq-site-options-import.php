 ...
 * @since  1.0.0
 */
class Templatiq_Site_Options_Import {

	/**
	 * Instance of Templatiq_Site_Options_Importer
	 *
	 * @since  1.0.0
	 * @var (Object) Templatiq_Site_Options_Importer
	 */
	private static $instance = null;

	/**
	 * Instantiate Templatiq_Site_Options_Importer
	 *
	 * @since  1.0.0
	 * @return (Object) Templatiq_Site_Options_Importer
	 */
	...
	private function set_elementor_kit() {
		...
		$args = array(
			...
			'meta_query'  => array( //phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_query -- Setting elementor kit. WP Query would have been expensive.
				array(
					'key'   => '_templatiq_sites_imported_post',
					'value' => '1',
				),
				array(
