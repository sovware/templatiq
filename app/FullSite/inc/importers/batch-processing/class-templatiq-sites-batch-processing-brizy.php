...
if ( ! class_exists( 'Templatiq_Sites_Batch_Processing_Brizy' ) ) :
	 ...
	 * @since 1.2.14
	 */
	class Templatiq_Sites_Batch_Processing_Brizy {
		...
		public function import() {
			...
			Templatiq_Sites_Importer_Log::add( '---- Processing WordPress Posts / Pages - for "Brizy" ----' );
		...
		public function import_single_post( $post_id = 0 ) {
			...
			templatiq_sites_error_log( '---- Processing WordPress Page - for "Brizy" ---- "' . $post_id . '"' );
			...
			if ( ! empty( $ids_mapping ) ) {
				...
				// Update WPForm IDs.
				templatiq_sites_error_log( '---- Processing WP Forms Mapping ----' );
				templatiq_sites_error_log( $ids_mapping );
	 ...
	 */
	Templatiq_Sites_Batch_Processing_Brizy::get_instance();
