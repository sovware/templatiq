...
namespace TemplatiqSites\Elementor;
...
if ( ! class_exists( 'Templatiq_Sites_Compatibility_Elementor' ) ) :
	 ...
	 * @since 2.0.0
	 */
	class Templatiq_Sites_Compatibility_Elementor {
		...
		public function __construct() {
			...
			add_action( 'templatiq_sites_before_delete_imported_posts', array( $this, 'force_delete_kit' ), 10, 2 );
			add_action( 'templatiq_sites_before_sse_import', array( $this, 'disable_attachment_metadata' ) );

			add_action( 'init', array( $this, 'init' ) );
			add_action( 'templatiq_sites_after_plugin_activation', array( $this, 'disable_elementor_redirect' ) );
		}
	 ...
	 */
	Templatiq_Sites_Compatibility_Elementor::get_instance();
