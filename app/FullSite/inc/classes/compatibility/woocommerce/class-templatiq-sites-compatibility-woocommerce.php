<?php
/**
 * Templatiq Sites Compatibility for 'WooCommerce'
 *
...
if ( ! class_exists( 'Templatiq_Sites_Compatibility_WooCommerce' ) ) :
	 ...
	 * @since 1.1.4
	 */
	class Templatiq_Sites_Compatibility_WooCommerce {
		...
		public function __construct() {
			add_action( 'templatiq_sites_import_start', array( $this, 'add_attributes' ), 10, 2 );
			add_action( 'templatiq_sites_after_plugin_activation', array( $this, 'install_wc' ), 10, 2 );
			...
			if ( class_exists( 'WooCommerce' ) ) {
				...
				add_action( 'templatiq_sites_import_complete', array( $this, 'update_wc_lookup_table' ) );
			}
			add_filter( 'templatiq_sites_pre_process_post_disable_content', '__return_false' );
			add_filter( 'templatiq_sites_pre_process_post_empty_excerpt', '__return_false' );
		}
	 ...
	 */
	Templatiq_Sites_Compatibility_WooCommerce::instance();
