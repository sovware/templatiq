...
const PageBuilder = () => {
	...
	const buildersList = [
		{
			id: 'gutenberg',
			title: __( 'Block Editor', 'templatiq-sites' ),
			image: `${ imageDir }block-editor.svg`,
		},
		{
			id: 'elementor',
			title: __( 'Elementor', 'templatiq-sites' ),
			image: `${ imageDir }elementor.svg`,
		},
		{
			id: 'beaver-builder',
			title: __( 'Beaver Builder', 'templatiq-sites' ),
	...
	if ( isBrizyEnabled === '1' ) {
		buildersList.push( {
			id: 'brizy',
			title: __( 'Brizy', 'templatiq-sites' ),
		...
		<div className="st-page-builder-filter">
			<ToggleDropdown
				...
				onClick={ ( event, option ) => {
					...
					content.append(
						'action',
						'templatiq-sites-change-page-builder'
					);
