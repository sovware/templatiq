...
if ( ! class_exists( 'Templatiq_Sites_Onboarding_Setup' ) ) :

	/**
	 * AI Site Setup
	 */
	class Templatiq_Sites_Onboarding_Setup {
		...
		public function __construct() {
			if ( 'spectra-one' === get_option( 'stylesheet', 'astra' ) ) {
				add_action( 'wp_ajax_templatiq_sites_set_site_data', array( $this, 'set_fse_site_data' ) );
			} else{
				add_action( 'wp_ajax_templatiq_sites_set_site_data', array( $this, 'set_site_data' ) );
			}
	...
	Templatiq_Sites_Onboarding_Setup::get_instance();
