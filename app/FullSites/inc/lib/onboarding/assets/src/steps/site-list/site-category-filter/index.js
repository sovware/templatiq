...
const SiteCategory = () => {
	...
	const allCategories = [
		{
			id: '',
			name: __( 'All', 'templatiq-sites' ),
			slug: '',
		},
		{
			id: '1',
			name: __( 'Blog', 'templatiq-sites' ),
			slug: 'Blog',
		},
		{
			id: '2',
			name: __( 'eCommerce', 'templatiq-sites' ),
			slug: 'eCommerce',
		},
		{
			id: '3',
			name: __( 'eLearning', 'templatiq-sites' ),
			slug: 'eLearning',
		},
		{
			id: '4',
			name: __( 'Restaurant', 'templatiq-sites' ),
			slug: 'Restaurant',
		},
		{
			id: '5',
			name: __( 'Agency', 'templatiq-sites' ),
			slug: 'Agency',
		},
		{
			id: '6',
			name: __( 'Local Business', 'templatiq-sites' ),
			slug: 'Local Business',
		},
		{
			id: '7',
			name: __( 'Professional', 'templatiq-sites' ),
			slug: 'Professional',
		},
	];
