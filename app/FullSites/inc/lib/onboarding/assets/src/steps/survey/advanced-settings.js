	...
	return (
		...
		>
			<p className="label-text row-label" onClick={ toggleSection }>
				{ __( 'Advanced Options', 'templatiq-sites' ) }
				...
				<ul>
							...
							<Tooltip
								content={
									<span>
										...
										<br />
										{ __(
											'Choose this option only if this is intended.You can find the backup to the current customizer settings at /wp-content/uploads templatiq-sites',
											'templatiq-sites'
										) }
									</span>
								}
					...
					{ 'installed-and-active' !== themeStatus && (
						<li>
							...
							<label htmlFor="import-theme">
								{ ' ' }
								{ __(
									'Install & Activate Templatiq Theme',
									'templatiq-sites'
								) }
							</label>
							<Tooltip
								content={ __(
									'To import the site in the original format, you would need the Templatiq theme activated. You can import it with any other theme, but the site might lose some of the design settings and look a bit different.',
									'templatiq-sites'
								) }
							>
								{ ICONS.questionMark }
					...
					<li>
						...
						<label htmlFor="import-widgets">
							{ ' ' }
							{ __( 'Import Widgets', 'templatiq-sites' ) }
						</label>
					</li>
					...
					<li>
						...
						<label htmlFor="import-content">
							{ ' ' }
							{ __( 'Import Content', 'templatiq-sites' ) }
						</label>
						<Tooltip
							content={ __(
					...
					{ isSurecartTemplate &&
						templatiqSitesVars.surecart_store_exists && (
							<li>
								<input
									type="checkbox"
									id="surecart-store"
