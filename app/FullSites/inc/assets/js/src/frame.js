var Frame = wp.media.view.Frame,
    TemplatiqAttachmentsBrowser;

wp.media.view.TemplatiqContent = require( './content.js' );

TemplatiqAttachmentsBrowser = Frame.extend({
    tagName:   'div',
    ...
    createContent: function() {
        ...
        this.views.add( new wp.media.view.TemplatiqContent );
...
module.exports = TemplatiqAttachmentsBrowser;