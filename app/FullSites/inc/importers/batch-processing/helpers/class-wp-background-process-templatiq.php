...
if ( class_exists( 'WP_Background_Process' ) ) :
	 ...
	 * @since 1.0.11
	 */
	class WP_Background_Process_Templatiq extends WP_Background_Process {
		...
		protected function complete() {
			...
			Templatiq_Sites_Importer_Log::add( 'Batch Process Complete!' );

			do_action( 'templatiq_sites_batch_process_complete' );
